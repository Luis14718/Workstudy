	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="inner-content">
								...
								<div class="graph">
									<nav>
										<ul>
											...
											<li><a href="#section-3" class="icon-food"><i class="fa fa-user-circle-o" aria-hidden="true"></i> <span>Boss</span></a></li>
											<li><a href="#section-4" class="icon-lab"><i class="fa fa-flask"></i> <span>Department</span></a></li>
				...
				<footer>
					<p>Keiser University Latin American Campus</p>
				</footer>
				<!--footer section end-->
			</div>
		</div>
		...
		<div class="sidebar-menu">
			<header class="logo">
				<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>Student View</h1></span> 
